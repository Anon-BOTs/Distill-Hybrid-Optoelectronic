...
class NuScenesSweepDataset(Custom3DDataset):
    ...
    def get_data_info(self, index):
        ...
        input_dict = dict(
            ...
            pts_filename=info["lidar_path"].replace('./data/nuscenes', '/high_perf_store/surround-view/datasets'),
            sweeps=info["sweeps"],
        ...
        if self.modality["use_camera"]:
            ...
            for cam_type, cam_info in info["cams"].items():
                path = cam_info["data_path"].replace('./data/nuscenes', '/high_perf_store/surround-view/datasets')
                ...
                for cam_idx, (cam_type, cam_infos) in enumerate(
                    ...
                    if len(cam_infos) == 0:
                        ...
                        for sweep_id, sweep_info in enumerate(
                            ...
                            cam_sweeps.append(sweep_info["data_path"].replace('./data/nuscenes', '/high_perf_store/surround-view/datasets'))
    ...
    def evaluate(
        ...
        import os
        import pickle
        # print('results saved to {}'.format(os.path.join(out_dir, 'results.pkl')))
