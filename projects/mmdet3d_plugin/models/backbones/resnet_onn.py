...
class ONNResNet(BaseModule):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(ONNResNet, self).__init__(init_cfg)
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(ONNResNet, self).train(mode)
        self._freeze_stages()
